...
int main() {
	...
	double start_time = omp_get_wtime();	//Register the starting time for quick sort
	if (choice_2 == 1)
		...
		cout << "Invalid choice.";
	double end_time = omp_get_wtime();	//Register the completion time for quick sort
	
	cout << "\nTime: " << (end_time - start_time)<<"\n";	//Calculate the running time for quick sort (difference between the completion time and starting time) and display it.
